...
const Products = () => {
  ...
  const [totalPages, setSetTotalPages] = useState(1)
...
//   incase sorting beak adre edana add madbeaku complete fetchproducts na comment madbeaku
// const fetchProducts = async () => {
//   setLoading(true);
          ...
          <div className="flex gap-8 xl:gap-10">
            ...
            <aside className="hidden lg:block w-64 shrink-0">
             <div className="bg-white rounded-2xl p-4 sticky top-24">
              <FilterPanel categories={categoriesData} category={category} organic={organic} minPrice={minPrice} maxPrice={maxPrice} clearFilters={clearFilters} hasFilters={hasFilters} updateFilter={updateFilter}  />
             </div>
            </aside>
           ...
           <main className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="flex flex-col lg:items-center gap-3">
                {/* mobile fliter toogle */}
                              <button
                                  onClick={() => setMobileFiltersOpen(true)}
                                  className="flex lg:hidden items-center gap-2 px-3 py-2 text-sm bg-white rounded-xl border border-app-border hover:bg-app-cream transition-colors"
                              >
        ...
        <>
         ...
         <div className="fixed bottom-0 left-0 right-0 bg-white z-50 rounded-t-2xl max-h-[80vh] overflow-y-auto animate-slide-in-up">
            <div className="flex items-center
             justify-between p-4 border-b border-app-border">
