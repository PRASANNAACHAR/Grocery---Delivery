      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <div className="bg-white/50 rounded-2xl overflow-hidden">
            <div className="grid md:grid-cols-2 gap-0">
              {/* left side details */}
              <div className="relative flex-center p-8 md:p-12 min-h-[320px] md:min-h-[480px] overflow-hidden">
                <img src={product.image} alt={product.name} className="max-h-[360px] w-auto object-contain" />
                
                 {/* badges */}
              <div className="absolute top-5 left-5 flex flex-wrap gap-1.5">
                {product.isOrganic && (
                  <span className="flex items-center gpa-1 px-2.5 py-1 text-xs font-semibold bg-app-green text-white rounded-full">
