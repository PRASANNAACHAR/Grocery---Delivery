...
const Hero = () => {
  return (
    <section className="relative overflow-hidden min-h-[540px] mb-10 rounded-3xl flex flex-center">
...
with <span className="text-orange-300">Earth's finest</span> 
            ...
            <p className="text-bas text-white/70 leading-relaxed mb-8 max-w-md">{heroSectionData.description}</p>
            ...
            <div className="flex flex-wrap gap-3">
                ...
                Shop Now <ArrowRightIcon className="size-4"/>
                 ...
                 <Link to="/products" className="px-7 py-3  bg-white/10 font-semibold rounded-full text-white hover:bg-white/20 transition-all border border-white/20">
                Browse Categories 
                </Link>
            </div>
          </div>
