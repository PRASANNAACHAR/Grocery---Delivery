...
const Navbar = () => {
    const user: any = {name: "john doe", email:"John@emaple.com", isAdmin: true}
                               ...
                               <div onClick={()=>setUserMenuOpen(false)}>
                                  ...
                                  {user && <Link to='/addresses' className="dropdown-link"><MapPinIcon size={16} /> Addresses</Link> }
                                   ...
                                   <Link to='/products' className="dropdown-link md:hidden"><ArrowUpRightIcon size={16} /> Products</Link> 
                                    ...
                                    {user?.isAdmin && (
                                      <Link to='/admin/products' className="dropdown-link"><ShieldIcon className="text-app-orange-dark" size={16} /><span className="text-app-orange-dark">Admin Panel</span>
                                      </Link>   
                                    )}
                                    {user && (
                                        <div className="border-t border-app-border pt-1">
                                            ...
                                            className="flex ietm-center gap-3 px-4 py-2.5 text-sm text-app-error hover:bg-red-50 w-full transition-colors" >
